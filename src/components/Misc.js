...
const explanation = (dsinfo = {}, introVideoPng) => html`<h1></h1>
  <svg class="title" viewBox="0 0 245 170" preserveAspectRatio="xMinYMin meet">
    <path
    ...
    />
    <text font-size=13px x=80 y=15>${dateFormatter(new Date(dsinfo.created || "2025-02-16"))} Benchmark</text>
    <text font-size=26px font-weight=bold x=80 y=46>AI Worldview</text>
    <text font-size=20px x=80 y=72>79.6% CORRECT</text>

    <text font-size=23px x=3 y=110>Chatbots are still</text>
    <text font-size=23px x=3 y=135>suffering from some</text>
    <text font-size=23px x=3 y=160>human misconceptions</text>
  </svg>
  <p class="video">
